		...
		if(a){
			if(b){
				if(SurfacesText[i].match(/^\d+pattern\d+,\d+,\d+,.+,\d+,\d+/i)){
					...
					Surface[num].element[ary[0]] = new Array();
					Surface[num].element[ary[0]].pattern = a[1];
					Surface[num].element[ary[0]].src = URL.Shell+ary[2];
					Surface[num].element[ary[0]].x = ary[3];
					Surface[num].element[ary[0]].y = ary[4];
