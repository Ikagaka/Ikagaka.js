...
$file[1] = "NaN";
$file[2] = "./index.html";		# 編集するテキストファイル(複数指定可能)
$file[3] = "./ikagaka/index.html";
$file[4] = "./ikagaka/ikagaka.js";	#   １つ以上のファイルを編集したい場合、
$file[5] = "./ikagaka/ghost.js";		#   必要に応じてファイルを追加する事ができます。
$file[6] = "./ikagaka/shell.js";				#   5つ以上ファイルがある場合は、
$file[7] = "./ikagaka/balloon.js";				#   []の中の数値を増やしていってください。
$file[8] = "./ikagaka/scope.js";
$file[9] = "./ikagaka/shiori.js";
$file[10] = "./ikagaka/other.js";

$file[12] = "./ikagaka/jquery.cleaner.js";
$file[13] = "./edit.cgi";
$file[14] = "./edit2.cgi";
...
if($FORM{'pass'} eq $pass){
	print'<form method="POST" action="edit2.cgi">';
	...
	print <<HTML;
	<body bgcolor="#FFFFFF">
	<form method="POST" action="edit2.cgi">
