...
$file[1] = "./index.html";		# 編集するテキストファイル(複数指定可能)
$file[2] = "./ikagaka.js";	#   １つ以上のファイルを編集したい場合、
$file[3] = "./ghost.js";		#   必要に応じてファイルを追加する事ができます。
$file[4] = "./shell.js";				#   5つ以上ファイルがある場合は、
$file[5] = "./balloon.js";				#   []の中の数値を増やしていってください。
$file[6] = "./scope.js";
$file[7] = "./edit.cgi";
...
if($FORM{'pass'} eq $pass){
	...
	<textarea name="file" rows="100" cols="800">
HTML
	open(O,"$file[$FORM{'name'}]") || &error("$file[$FORM{'name'}]ファイルを開けません",__LINE__);
	while(<O>){
		$v="$_";
