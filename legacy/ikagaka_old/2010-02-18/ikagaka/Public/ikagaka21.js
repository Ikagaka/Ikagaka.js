...
if(typeof(named)&&typeof(id)){
	...
	$("#Ikagaka>.named"+this.parent.id+">.scope"+this.id+">,.base").prepend(
		$("<div>")
		.addClass("scope" + this.id)
		.addClass("scope")
		.addClass("root")
	...
	$("#Ikagaka>.named"+this.parent.id+">.root").prepend(
		$("<img>")
		.addClass("scope" + this.id)
		.addClass("scope")
		.addClass("surface")
	...
	$("#Ikagaka .scope"+this.id+" .envelope").prepend(
		$("<div>")
		.addClass("text")
		.cleaner()
		.css("z-index","2000")
...
//		img.src = surface.src;
		if(img.width>0){
			$("#Ikagaka .named"+named.id+" .scope"+this.id)
				.width(img.width+"px")
