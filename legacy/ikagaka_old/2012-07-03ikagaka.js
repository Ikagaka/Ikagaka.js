...
ikagaka = (function() {
  var canvedElements, composeElements, copyCnv, drawCnv, getOffset, isArray, isCanvas, isFunction, isHit, isImage, isNumber, isObject, isUndefined, loadImg, loadImgsToCnvs, makeNamed, namedAry, overlayCnv, overlayfastCnv, setCollisions, transImg, typeIs;
  ...
  getOffset = (function() {
    var body, conMarginTop, container, div, html, inner, jQuery, outer, paddingMarginBorder, paddingMarginBorderVisibility, positionTopLeftWidthHeight, rtable, style, td;
    jQuery = {};
    jQuery.support = {};
    rtable = /^t(?:able|d|h)$/i;
    ...
    jQuery.support.fixedPosition = inner.offsetTop === 20 || inner.offsetTop === 15;
    jQuery.support.doesNotAddBorder = inner.offsetTop !== 5;
    jQuery.support.doesAddBorderForTableAndCells = td.offsetTop === 5;
    jQuery.support.subtractsBorderForOverflowNotVisible = inner.offsetTop === -5;
    body.removeChild(container);
    div = container = null;
    return function(elem) {
      var computedStyle, defaultView, doc, docElem, left, offsetParent, prevComputedStyle, prevOffsetParent, top;
  ...
  asyncTest("setCollisions", function() {
    var colAry, elmAry;
    elmAry = [["base", "./ku-/shell/master/surface0.png"]];
  ...
  namedAry = [];
  makeNamed = function(opt) {
    var curScope, eventHandlerHash, isTalking, makeScope, namedId, scopeAry, scriptTidAry, _callback, _json;
    makeScope = function(n) {
      var curBlimp, curBlimpObj, curSurface, curSurfaceObj, makeBlimp, makeSurface, scopeID;
      makeSurface = function(n) {
        return {
    ...
    _json = opt.json, _callback = opt.callback;
  ...
  return {
    "createNamed": function(json, opt, callback) {
      if (json == null) {
        json = {};
      }
      if (opt == null) {
